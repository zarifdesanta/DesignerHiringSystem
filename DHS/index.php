...
<html>
	...
	<?php if($_SESSION['user_role'] == "Designer"): ?>
		...
		<div class="container">
			    ...
			    <div class="nav-wrapper">
			      <form action="index.php" method="POST">
			        <div class="input-field white">
			          ...
			          <label class="label-icon" for="search"><i class="material-icons brand-text">search</i></label>
			...
			<input type="submit" name="search_requirement" value="Search" class="btn brand z-depth-0">-->
	...
	<?php elseif($_SESSION['user_role'] == "Client"): ?>
		...
		<div class="container">
			    ...
			    <div class="nav-wrapper">
			      <form action="index.php" method="POST">
			        <div class="input-field white">
			          ...
			          <input type="search" name="keyword" required>
			          <label class="label-icon" for="search"><i class="material-icons brand-text">search</i></label>
			          <input type="hidden" name="search_portfolio" value="Search">
			...
			<form action="index.php" method="POST">
			<input type="text" name="keyword">
			<input type="submit" name="search_portfolio" value="Search" class="btn brand">-->
						...
						<div class="col s4 md3">
							<div class="card medium">
								...
								<div class="card-content center">
									...
									<div>Name: <?php echo 'Name: ' . htmlspecialchars($portfolio['username']) ?></div>
						...
						<div class="col s4 md3">
							<div class="card medium">
								...
								<div class="card-content center">
									...
									<h6><?php echo htmlspecialchars($portfolio['expert_at']) ?></h6>
									<div>Name: <?php echo htmlspecialchars($portfolio['username']) ?></div>
	...
	<?php else: ?>
		...
		<div class="container">
			    ...
			    <div class="nav-wrapper">
			      <form action="index.php" method="POST">
			        <div class="input-field white">
			          ...
			          <input type="search" name="keyword" required>
			          <label class="label-icon" for="search"><i class="material-icons brand-text">search</i></label>
			          <input type="hidden" name="search_user" value="Search">
			...
			<form action="index.php" method="POST">
			<input type="text" name="keyword">
			<input type="submit" name="search_user" value="Search" class="btn brand">-->
